...
function AdminTreatments() {
  ...
  const selectTreatment = (treatment) => {
    ...
    setDraft(normalizeTreatmentRecord(treatment))
    setErrors({})
    setFeedback("")
  }
  ...
  const createNewTreatment = () => {
    setSelectedTreatmentId("new")
    setDraft(getEmptyTreatmentDraft(defaultDepositValue))
    setErrors({})
    setFeedback("")
  }
            ...
            <section className="admin-subpanel admin-subpanel--stretch">
              ...
              <div className="admin-form-actions admin-form-actions--sticky-mobile">
                ...
                <div className="admin-action-row">
                  ...
                  {draft.id ? (
                    activeTreatment?.status === TREATMENT_STATUS.INACTIVE ? (
                      <button type="button" className="ghost-button" disabled={isSaving} onClick={() => persistTreatment(TREATMENT_STATUS.ACTIVE)}>
                        Reactivate
                      </button>
                    ) : (
                      <button
